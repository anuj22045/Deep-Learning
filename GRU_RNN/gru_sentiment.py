#it output score is bad because this dataset is too small to train and test you an download the dataset from kaggle name 
# IMDb Movie Reviews dataset and perform the same code to get the best output 
